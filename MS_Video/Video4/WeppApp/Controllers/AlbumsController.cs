...
namespace WeppApp.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Artist,Name,Gene,ReleaseDate,Price")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Artist,Name,Gene,ReleaseDate,Price")] Album album)
        {
            if (id != album.ID)
            {
                return NotFound();
